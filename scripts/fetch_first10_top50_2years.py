"""
Fetch first 10 stocks from top 50 at 30-minute intervals for the past 2 years using Alpaca API.
"""
import pandas as pd
...
def main():
    ...
    print("=" * 80)
    print("FETCHING FIRST 10 STOCKS FROM TOP 50 (30-MINUTE INTERVALS) - 2 YEARS")
    ...
    try:
        ...
        output_file = f"first10_top50_30min_2years_alpaca_{end_date.strftime('%Y%m%d')}.csv"
