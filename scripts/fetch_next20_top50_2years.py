"""
Fetch next 20 stocks (21-40) from top 50 at 30-minute intervals for the past 2 years using Alpaca API.
"""
import pandas as pd
...
# Next 20 stocks from top 50 (stocks 21-40)
NEXT_20_STOCKS = [
...
def main():
    ...
    print("=" * 80)
    print("FETCHING NEXT 20 STOCKS (21-40) FROM TOP 50 (30-MINUTE INTERVALS) - 2 YEARS")
    ...
    try:
        ...
        output_file = f"next20_top50_30min_2years_alpaca_{end_date.strftime('%Y%m%d')}.csv"
