"""
Fetch next 10 stocks (11-20) from top 50 at 30-minute intervals for the past 2 years using Alpaca API.
"""
import pandas as pd
...
# Next 10 stocks from top 50 (stocks 11-20)
NEXT_10_STOCKS = [
...
def main():
    ...
    print("=" * 80)
    print("FETCHING NEXT 10 STOCKS (11-20) FROM TOP 50 (30-MINUTE INTERVALS) - 2 YEARS")
    ...
    try:
        ...
        output_file = f"next10_top50_30min_2years_alpaca_{end_date.strftime('%Y%m%d')}.csv"
